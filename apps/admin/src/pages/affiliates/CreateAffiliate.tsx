...
import { createAffiliate } from '@cpatracker/mock';
...
export function CreateAffiliate() {
  ...
  const valid = name.trim().length > 0 && email.trim().length > 0 && country.trim().length > 0;
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <h1 className="text-2xl font-semibold">Create Affiliate</h1>
