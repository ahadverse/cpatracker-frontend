...
import {
  getNetworkAdminDashboardStats,
  getAdvertisers,
  getAffiliates,
  getInvoices,
  getOffers,
  getPerformanceReport,
  type NetworkAdminDashboardStats,
...
interface DashboardData {
  stats: NetworkAdminDashboardStats;
...
async function loadDashboardData(): Promise<DashboardData> {
  const [stats, trendRaw, byOffer, byAffiliate, byAdvertiser, offers, affiliates, advertisers, invoices] =
    await Promise.all([
      getNetworkAdminDashboardStats(),
      getPerformanceReport({ groupBy: 'date', role: 'NETWORK_ADMIN' }),
      getPerformanceReport({ groupBy: 'offer', role: 'NETWORK_ADMIN' }),
      getPerformanceReport({ groupBy: 'affiliate', role: 'NETWORK_ADMIN' }),
      getPerformanceReport({ groupBy: 'advertiser', role: 'NETWORK_ADMIN' }),
      getOffers(),
      getAffiliates(),
      getAdvertisers(),
      getInvoices(),
